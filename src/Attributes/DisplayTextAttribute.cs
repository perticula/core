...
public static class DisplayTextAttributeExtensions
{
  ...
  public static string DisplayText(this Enum value, params object[] arguments)
  {
    ...
    var formatted = string.Format(attribute.DisplayText ?? "{0}", arguments);
  ...
  /// <param name="value">The value.</param>
  /// <returns>T.</returns>
  /// <exception cref="InvalidCastException">Value could not be cast into an enumeration</exception>
