...
public static class DigestUtilities
{
	...
	public static DerObjectIdentifier? GetObjectIdentifier(string mechanism)
	{
		...
		mechanism = CollectionExtensions.GetValueOrKey(Aliases, mechanism).ToUpperInvariant();

		return CollectionExtensions.GetValueOrNull(Oids, mechanism);
	}
	...
	public static IDigest GetDigest(string algorithm)
	{
		...
		var mechanism = CollectionExtensions.GetValueOrKey(Aliases, algorithm).ToUpperInvariant();
		try
		{
	...
	public static string GetAlgorithmName(DerObjectIdentifier oid) => CollectionExtensions.GetValueOrNull(Aliases, oid.Id);
