...
public class DerEncoding : IAsn1Encoding, IComparable<DerEncoding>
{
		/// <summary>
		///   The contents octets
		/// </summary>
		...
		public virtual void Encode(Asn1OutputStream buffer)
		{
				buffer.WriteIdentifier(TagClass, TagNo);
				buffer.WriteDL(ContentsOctets.Length);
				buffer.Write(ContentsOctets, 0, ContentsOctets.Length);
		}
		...
		public virtual int GetLength() => Asn1OutputStream.GetLengthOfEncodingDL(TagNo, ContentsOctets.Length);
		...
		protected virtual int CompareLengthAndContents(DerEncoding other)
		{
				...
				ContentsOctetsLength = ContentsOctets.Length;
				if (ContentsOctetsLength != other.ContentsOctets.Length) return ContentsOctetsLength - other.ContentsOctets.Length;
