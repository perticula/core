// perticula - core - DerUtf8String.cs
// 
...
public class DerUtf8String : DerString
{
	/// <summary>
	///   The contents
	/// </summary>
	...
	/// <summary>
	///   Initializes a new instance of the <see cref="DerUtf8String" /> class.
	/// </summary>
	/// <param name="str">The string.</param>
	public DerUtf8String(string str) : this(str.ToUtf8ByteArray(), false) { }

	/// <summary>
	///   Initializes a new instance of the <see cref="DerUtf8String" /> class.
	/// </summary>
	/// <param name="contents">The contents.</param>
	public DerUtf8String(byte[] contents) : this(contents, true) { }
	...
	/// <returns>System.Nullable&lt;DerUtf8String&gt;.</returns>
	/// <exception cref="System.ArgumentException">failed to construct UTF8 string from byte[]: {e.Message}</exception>
	...
	/// <returns>DerUtf8String.</returns>
	public static DerUtf8String GetInstance(Asn1TaggedObject taggedObject, bool declaredExplicit) => (DerUtf8String) Meta.Instance.GetContextInstance(taggedObject, declaredExplicit);

	/// <summary>
	///   Gets the current string value.
	/// </summary>
	/// <returns>System.String.</returns>
	public override string GetString() => _contents.FromUtf8ByteArray();
	...
	protected override bool Asn1Equals(Asn1Object asn1Object) => asn1Object is DerUtf8String that && Arrays.AreEqual(_contents, that._contents);
	...
	internal override IAsn1Encoding GetEncoding(int encoding) => new Asn1Encoding(Asn1Tags.Universal, Asn1Tags.Utf8String, _contents);
	...
	internal sealed override DerEncoding GetEncodingDer() => new(Asn1Tags.Universal, Asn1Tags.Utf8String, _contents);
	...
	/// <param name="contents">The contents.</param>
	/// <returns>DerUtf8String.</returns>
	internal static DerUtf8String CreatePrimitive(byte[] contents) => new(contents, false);
