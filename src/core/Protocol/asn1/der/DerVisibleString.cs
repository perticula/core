// perticula - core - DerVisibleString.cs
// 
...
public class DerVisibleString : DerString
{
	/// <summary>
	///   The contents
	/// </summary>
	...
	/// <summary>
	///   Initializes a new instance of the <see cref="DerVisibleString" /> class.
	/// </summary>
	...
	public DerVisibleString(byte[] contents) : this(contents, true) { }
	...
	/// <returns>System.Nullable&lt;DerVisibleString&gt;.</returns>
	/// <exception cref="System.ArgumentException">failed to construct visible string from byte[]: {e.Message}</exception>
	...
	/// <returns>DerVisibleString.</returns>
	public static DerVisibleString GetInstance(Asn1TaggedObject taggedObject, bool declaredExplicit) => (DerVisibleString) Meta.Instance.GetContextInstance(taggedObject, declaredExplicit);
	...
	internal override IAsn1Encoding GetEncoding(int encoding) => new Asn1Encoding(Asn1Tags.Universal, Asn1Tags.VisibleString, _contents);
	...
	internal sealed override DerEncoding GetEncodingDer() => new(Asn1Tags.Universal, Asn1Tags.VisibleString, _contents);
	...
	protected override bool Asn1Equals(Asn1Object asn1Object) => asn1Object is DerVisibleString that && Arrays.AreEqual(_contents, that._contents);
	...
	/// <param name="contents">The contents.</param>
	/// <returns>DerVisibleString.</returns>
	internal static DerVisibleString CreatePrimitive(byte[] contents) => new(contents, false);
