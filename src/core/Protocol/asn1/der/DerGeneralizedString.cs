// perticula - core - DerGeneralizedString.cs
// 
...
public class DerGeneralString : DerString
{
	/// <summary>
	///   The contents
	/// </summary>
	...
	/// <summary>
	///   Initializes a new instance of the <see cref="DerGeneralString" /> class.
	/// </summary>
	...
	public DerGeneralString(byte[] contents) : this(contents, true) { }
	...
	/// <returns>System.Nullable&lt;DerGeneralString&gt;.</returns>
	/// <exception cref="System.ArgumentException">failed to construct general string from byte[]: {e.Message}</exception>
	...
	public static DerGeneralString? GetInstance(object? obj)
	{
		switch (obj)
		{
			case null:
				return null;
			case DerGeneralString derGeneralString:
	...
	/// <returns>DerGeneralString.</returns>
	public static DerGeneralString GetInstance(Asn1TaggedObject taggedObject, bool declaredExplicit) => (DerGeneralString) Meta.Instance.GetContextInstance(taggedObject, declaredExplicit);
	...
	internal override IAsn1Encoding GetEncoding(int encoding) => new Asn1Encoding(Asn1Tags.Universal, Asn1Tags.GeneralString, _contents);
	...
	internal sealed override DerEncoding GetEncodingDer() => new(Asn1Tags.Universal, Asn1Tags.GeneralString, _contents);
	...
	protected override bool Asn1Equals(Asn1Object asn1Object) => asn1Object is DerGeneralString that && Arrays.AreEqual(_contents, that._contents);
	...
	/// <param name="contents">The contents.</param>
	/// <returns>DerGeneralString.</returns>
	internal static DerGeneralString CreatePrimitive(byte[] contents) => new(contents, false);
